**Fig 3 generation with energy shares with denominator as TOTAL gen, using vulnerability (relative) as the alternative metric, regardless of signficance level 
*SI Figure S8
...
**Contains multivariate regression result for Panel A (multivariate regression)

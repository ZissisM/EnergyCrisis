**Fig 7 with generation shares using LOAD as the denominator 
clear

use allcountries_loadshares
...
replace z2=2 if Country=="NL"
replace z2=8 if Country=="CZ"
...
replace z3=11 if Country=="LT"
replace z3=3 if Country=="AT"
replace z3=1 if Country=="DK"
replace z3=3 if Country=="NL"
replace z3=4 if Country=="PL"
...
graph export Fig7_load.jpg,replace
...
// outreg2 using TableSImultivariateSharesLoad.doc, replace se label bdec(2) nocons adds(F-test,r(F),Prob>F,`r(p)') adjr2
// replace Solar = . in 7
